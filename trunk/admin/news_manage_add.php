...
id="form1">
  ...
  <table cellpadding="0" cellspacing="0" class="l-table-edit">
    <tr>
      ...
      <td align="left" class="l-table-edit-td"><input name="news_title" type="text" id="news_title" ltype="text" ligerui="{width:'500px'}" validate="{required:true,minlength:3,maxlength:32}" /></td>
      <td align="left"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" class="l-table-edit-td"><input name="news_post_time" type="text" id="news_post_time" ltype="date" ligerui="{showTime: true, format:'yyyy-MM-dd hh:mm:ss', width:'200px'}" validate=""
                /></td>
      <td align="left"></td>
    </tr>
    <tr>
